...
<html lang="en">
	<!--begin::Head-->
	<head>
		<title>Asia Technological School Of Science And Arts | Sign Up</title>
		<meta charset="utf-8" />
	...
	<body id="kt_body" class="bg-body">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-column flex-lg-row flex-column-fluid stepper stepper-pills stepper-column" id="kt_create_account_stepper">
				<!--begin::Aside-->
				<div class="d-flex flex-column flex-lg-row-auto w-xl-600px positon-xl-relative col-xs-12 bg-lighten shadow-sm" style="background: url('image/asia-tech-img.jpg') no-repeat center #004914; background-size: cover; min-width: 300px; min-height: 70vh;">
					<!--begin::Wrapper-->
					<div class="d-flex flex-column w-xl-400px scroll-y m-auto" style="background: rgba(255, 255, 255, 0.9); border-radius: 10px; box-shadow: 0px 0px 20px 0px rgba(0,0,0,0.3); -webkit-box-shadow: 0px 0px 20px 0px rgba(0,0,0,0.3);-moz-box-shadow: 0px 0px 20px 0px rgba(0,0,0,0.3);">
						<!--begin::Header-->
						<div class="d-flex flex-row-fluid flex-column flex-center p-10 pt-lg-20">
							<!--begin::Logo-->
							<a href="index.php" class="mb-10 mb-lg-20">
								<img alt="Logo" src="image/asia-tech-logo-3.png" class="h-50px" />
							</a>
							<!--end::Logo-->
							<!--begin::Nav-->
							<div class="stepper-nav">
								...
								<div class="stepper-item current" data-kt-stepper-element="nav">
									...
									<div class="stepper-label">
										...
										<div class="stepper-desc fw-bold">Setup Your Registration Type</div>
									</div>
									<!--end::Label-->
								</div>
								<!--end::Step 1-->
								...
								<div class="stepper-item" data-kt-stepper-element="nav">
									...
									<div class="stepper-label">
										...
										<div class="stepper-desc fw-bold">Setup Your Residential Information</div>
									</div>
									<!--end::Label-->
								</div>
								<!--end::Step 4-->
							...
							<form class="my-auto pb-5" novalidate="novalidate" id="kt_create_account_form">
								...
								<div class="current" data-kt-stepper-element="content">
									...
									<div class="w-100">
										...
										<div class="pb-10 pb-lg-15">
											<!--begin::Title-->
											<h2 class="fw-bolder text-dark">Setup Your Registration Type</h2>
											<!--end::Title-->
											<!--begin::Notice-->
										...
										<div class="fv-row">
											...
											<div class="row">
												...
												<div class="col-lg-6">
													<!--begin::Option-->
													<input type="radio" class="btn-check" name="registration_type" value="new" checked id="kt_create_account_form_registration_type_new" />
													<label class="btn btn-outline btn-outline-dashed btn-outline-default p-7 d-flex align-items-center mb-10" for="kt_create_account_form_registration_type_new">
												...
												<div class="col-lg-6">
													<!--begin::Option-->
													<input type="radio" class="btn-check" name="registration_type" value="old" id="kt_create_account_form_registration_type_old" />
													<label class="btn btn-outline btn-outline-dashed btn-outline-default p-7 d-flex align-items-center" for="kt_create_account_form_registration_type_old">
								...
								<div class="" data-kt-stepper-element="content">
									...
									<div class="w-100">
										...
										<div class="pb-10 pb-lg-15">
											<!--begin::Title-->
											<h2 class="fw-bolder text-dark">Setup Your Account Information</h2>
											<!--end::Title-->
											<!--begin::Notice-->
											<div class="text-muted fw-bold fs-6">Want to go back? 
											<a href="index.php" class="link-primary fw-bolder">Sign In</a>.</div>
								...
								<div class="" data-kt-stepper-element="content">
									...
									<div class="w-100">
										...
										<div class="pb-10 pb-lg-15">
											<!--begin::Title-->
											<h2 class="fw-bolder text-dark">Setup Your Residential Information</h2>
											<!--end::Title-->
											<!--begin::Notice-->
											<div class="text-muted fw-bold fs-6">Want to go back? 
											<a href="index.php" class="link-primary fw-bolder">Sign In</a>.</div>
								...
								<div class="" data-kt-stepper-element="content">
									...
									<div class="w-100">
										...
										<div class="mb-0">
											<!--begin::Text-->
											<div class="fs-6 text-gray-600 mb-5">Congratulations! We look forward to continuing our great relationships with Asia Technological School of Science and Arts and all of our community partners who support us. Thank you for taking the time to register in our online grading system!</div>
											<!--end::Text-->
										</div>
										<!--end::Body-->
									</div>
								...
								<div class="d-flex flex-stack pt-15">
									<div class="mr-2">
										<button type="button" class="btn btn-lg btn-success me-3" data-kt-stepper-action="previous">
					...
					<div class="d-flex flex-center flex-wrap fs-6 p-5 pb-0">
						...
						<div class="d-flex flex-center fw-bold fs-6">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="#" target="_blank" class="text-gray-800 text-hover-primary">2022 Student Grading System</a>
							</div>
							<!--end::Copyright-->
						</div>
						<!--end::Links-->
