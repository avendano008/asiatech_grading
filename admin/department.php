<?php
	$department = array (
		array("department_name"=>"ABM","description"=>"Accountancy and Business Management"),
		array("department_name"=>"STEM","description"=>"Science, Technology, Engineering and Mathematics"),
		array("department_name"=>"HUMSS","description"=>"Humanities and Social Sciences"),
		array("department_name"=>"GAS","description"=>"General Academic Strand"),
		array("department_name"=>"ICT","description"=>"Information and Communications Technology"),
		array("department_name"=>"HE","description"=>"Home Economics")
	);
?>
<!--begin::Toolbar-->
					...
					<tbody class="fw-bold text-gray-600">
						<?php for($i = 0; $i < count($department); $i++): ?>
							...
							<tr>
								...
								<td>
									<a href="?page=department-info" class="text-dark text-hover-primary"><?=$department[$i]['department_name']?></a>
								</td>
								<!--end::Department name=-->
								<!--begin::Description=-->
