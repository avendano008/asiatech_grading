...
<div class="post d-flex flex-column-fluid" id="kt_post">
	...
	<div id="kt_content_container" class="container-xxl">
		...
		<div class="card card-flush">
					...
					<tbody class="fw-bold text-gray-600">
						<?php for($i = 0; $i < count($faculty); $i++): ?>
							...
							<tr>
								...
								<!--begin::Actions=-->
								<td class="text-end">
									<a href="#" class="px-3 text-hover-primary" data-toggle="tooltip" data-placement="top" title="Edit" data-bs-toggle="modal" data-bs-target="#kt_modal_edit_faculty">
									...
									<div class="stepper-nav">
										...
										<div class="stepper-item" data-kt-stepper-element="nav">
											...
											<div class="stepper-label">
												...
												<div class="stepper-desc fw-bold">Setup Registration Information</div>
											</div>
											<!--end::Label-->
										</div>
										<!--end::Step 2-->
										...
										<div class="stepper-item" data-kt-stepper-element="nav">
											...
											<div class="stepper-label">
												...
												<div class="stepper-desc fw-bold">A faculty Has Been Added</div>
											</div>
											<!--end::Label-->
										</div>
										<!--end::Step 5-->
									...
									<form class="form" novalidate="novalidate" id="kt_modal_add_faculty_form">
													...
													<div class="row">
														...
														<div class="col-lg-6">
															...
															<label class="btn btn-outline btn-outline-dashed btn-outline-default p-7 align-items-center mb-10" for="kt_create_account_form_registration_type_new">
																...
																<span class="d-block fw-bold my-2">
																	<span class="text-dark fw-bolder d-block fs-4 mb-2">New faculty</span>
																	<span class="text-muted fw-bold fs-6">Are you a new faculty? Please click the continue button below to complete your registration.</span>
																</span>
																<!--end::Info-->
															</label>
															<!--end::Option-->
														...
														<div class="col-lg-6">
															...
															<label class="btn btn-outline btn-outline-dashed btn-outline-default p-7 align-items-center mb-10" for="kt_create_account_form_registration_type_old">
																...
																<!--begin::Info-->
																<span class="d-block fw-bold my-2">
																	<span class="text-dark fw-bolder d-block fs-4 mb-2">Old faculty</span>
																	<span class="text-muted fw-bold fs-6">Are you an old faculty? Please click the continue button below to complete your registration.</span>
																</span>
																<!--end::Info-->
															</label>
															<!--end::Option-->
										...
										<div class="" data-kt-stepper-element="content">
											...
											<div class="w-100">
												...
												<div class="pb-10 pb-lg-15">
													<!--begin::Title-->
													<h2 class="fw-bolder text-dark">Setup Registration Information</h2>
													<!--end::Title-->
												</div>
												<!--end::Heading-->
												<!--begin::Input group-->
										...
										<div class="" data-kt-stepper-element="content">
											...
											<div class="w-100">
												...
												<div class="mb-0">
													<!--begin::Text-->
													<div class="fs-6 text-gray-600 mb-5">A faculty has been successfully added to our online grading system.</div>
													<!--end::Text-->
												</div>
												<!--end::Body-->
											</div>
			...
			<!--begin::Modal - Edit faculty-->
			<div class="modal fade" id="kt_modal_edit_faculty" tabindex="-1" aria-hidden="true">
				<!--begin::Modal dialog-->
				<div class="modal-dialog modal-dialog-centered mw-900px">
					<!--begin::Modal content-->
					<div class="modal-content">
						...
						<div class="modal-body py-lg-10 px-lg-10">
							<!--begin::Stepper-->
							<div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid" id="kt_modal_edit_faculty_stepper">
								<!--begin::Aside-->
								<div class="d-flex justify-content-center justify-content-xl-start flex-row-auto w-100 w-xl-300px">
									<!--begin::Nav-->
									<div class="stepper-nav">
										...
										<div class="stepper-item" data-kt-stepper-element="nav">
											...
											<div class="stepper-label">
												<h3 class="stepper-title">Complete</h3>
												<div class="stepper-desc fw-bold">A faculty Has Been Updated</div>
											</div>
											<!--end::Label-->
										</div>
										<!--end::Step 5-->
								...
								<div class="flex-row-fluid py-lg-5 px-lg-15">
									<!--begin::Form-->
									<form class="form" novalidate="novalidate" id="kt_modal_edit_faculty_form">
										<!--begin::Step 1-->
										<div class="current" data-kt-stepper-element="content">
											<!--begin::Wrapper-->
											<div class="w-100">
