<?php
	$faculty = array (
			  array("faculty_name"=>"Emma Smith", 
			  	"faculty_id"=>"FID-00001", 
			  	"department"=>"ABM", 
			  	"user_type"=>"Teacher", 
			  	"gender"=>"Female", 
			  ...
			  array("faculty_name"=>"Sam Greenhills", 
			  	"faculty_id"=>"FID-00002", 
			  	"department"=>"STEM", 
			  	"user_type"=>"Registrar", 
			  	"gender"=>"Female", 
		...
		<div class="card card-flush">
			...
			<div class="card-header align-items-center py-5 gap-2 gap-md-5">
				...
				<div class="card-toolbar d-flex justify-content-end gap-5" data-kt-faculty-list-toolbar="base"/>
						...
						<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
							...
							<div class="px-7 py-5" data-kt-faculty-list-filter="form">
								...
								<div class="mb-10">
									...
									<select class="form-select form-select-solid fw-bolder" data-kt-select2="true" data-placeholder="Select Option" data-allow-clear="true" data-kt-faculty-list-filter="department" data-hide-search="true">
										<option></option>
								...
								<!--end::Input group-->
								<div class="mb-10">
									<label class="form-label fs-6 fw-bold">User Type:</label>
									<select class="form-select form-select-solid fw-bolder" data-kt-select2="true" data-placeholder="Select Option" data-allow-clear="true" data-kt-faculty-list-filter="user_type" data-hide-search="true">
										<option></option>
					...
					<!--end::Export dropdown-->
					<!--begin::Add faculty-->
					<button type="button" class="btn btn-primary w-200px" data-bs-toggle="modal" data-bs-target="#kt_modal_add_faculty">
					...
					<tbody class="fw-bold text-gray-600">
						<?php for($i = 0; $i < count($faculty); $i++): ?>
							...
							<tr>
								...
								<!--end::Faculty name=-->
								<!--begin::Faculty id=-->
								<td><?=$faculty[$i]['faculty_id']?></td>
								<!--end::Faculty id=-->
								<!--begin::Department=-->
								<td><?=$faculty[$i]['department']?></td>
								<!--begin::Department=-->
								<!--begin::User type=-->
								<td><?=$faculty[$i]['user_type']?></td>
								<!--end::User type=-->
								<!--begin::Gender=-->
								...
								<!--end::Address=-->
								<!--begin::Contact email=-->
								<td class="d-none"><?=$faculty[$i]['contact_email']?></td>
								<!--end::Contact email=-->
								<!--begin::Contact number=-->
								<td class="d-none"><?=$faculty[$i]['contact_number']?></td>
								<!--end::Contact number=-->
								<!--begin::Actions=-->
								<td class="text-end">
...
<!--end::Post-->
<!--begin::Modal - Add Faculty-->
<div class="modal fade" id="kt_modal_add_faculty" tabindex="-1" aria-hidden="true">
	<!--begin::Modal dialog-->
	<div class="modal-dialog modal-dialog-centered mw-900px">
		...
		<div class="modal-content">
			...
			<div class="modal-body py-lg-10 px-lg-10">
				<!--begin::Stepper-->
				<div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid" id="kt_modal_add_faculty_stepper">
					<!--begin::Aside-->
						...
						<div class="stepper-nav">
							...
							<div class="stepper-item current" data-kt-stepper-element="nav">
								...
								<div class="stepper-label">
									<h3 class="stepper-title">Faculty Info</h3>
									<div class="stepper-desc fw-bold">Setup Faculty Information</div>
								</div>
								<!--end::Label-->
							</div>
							<!--end::Step 1-->
							...
							<div class="stepper-item" data-kt-stepper-element="nav">
								...
								<div class="stepper-label">
									...
									<div class="stepper-desc fw-bold">Faculty Has Been Added</div>
								</div>
								<!--end::Label-->
							</div>
							<!--end::Step 4-->
					...
					<div class="flex-row-fluid py-lg-5 px-lg-15">
						<!--begin::Form-->
						<form class="form" novalidate="novalidate" id="kt_modal_add_faculty_form">
							<!--begin::Step 1-->
							<div class="current" data-kt-stepper-element="content">
								...
								<div class="w-100">
									...
									<div class="pb-10 pb-lg-15">
										<!--begin::Title-->
										<h2 class="fw-bolder text-dark">Setup Faculty Information</h2>
										<!--end::Title-->
									</div>
									<!--end::Heading-->
									<!--begin::Input group-->
									<div class="mb-10 fv-row">
										<!--begin::Label-->
										<label class="d-flex align-items-center form-label mb-3">User Type
										<i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Please select your user type"></i></label>
										<!--end::Label-->
										<!--begin::Row-->
										<div class="row mb-2" data-kt-buttons="true">
											...
											<div class="col">
												...
												<label class="btn btn-outline btn-outline-dashed btn-outline-default w-100 p-4 active">
													<input type="radio" class="btn-check" name="user_type" value="Teacher" checked />
													<span class="fw-bolder fs-3">Teacher</span>
												</label>
												<!--end::Option-->
											</div>
											<!--end::Col-->
											...
											<div class="col">
												...
												<label class="btn btn-outline btn-outline-dashed btn-outline-default w-100 p-4">
													<input type="radio" class="btn-check" name="user_type" value="Registrar" />
													<span class="fw-bolder fs-3">Registrar</span>
												</label>
												<!--end::Option-->
											</div>
											<!--end::Col-->
									...
									<div class="mb-0 fv-row">
										<!--begin::Label-->
										<label class="d-flex align-items-center form-label mb-5">Department
										<i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Please select your department"></i></label>
										<!--end::Label-->
										<!--begin::Options-->
										<div class="mb-0">
											<!--begin:Option-->
											<label class="d-flex flex-stack mb-5 cursor-pointer">
												...
												<span class="form-check form-check-custom form-check-solid">
													<input class="form-check-input" type="radio" name="department" value="ABM" checked="checked"/>
												</span>
												<!--end:Input-->
											</label>
											<!--end::Option-->
											...
											<label class="d-flex flex-stack mb-5 cursor-pointer">
												...
												<!--begin:Input-->
												<span class="form-check form-check-custom form-check-solid">
													<input class="form-check-input" type="radio" name="department" value="STEM" />
												</span>
												<!--end:Input-->
											</label>
											<!--end::Option-->
											...
											<label class="d-flex flex-stack mb-5 cursor-pointer">
												...
												<!--begin:Input-->
												<span class="form-check form-check-custom form-check-solid">
													<input class="form-check-input" type="radio" name="department" value="HUMSS" />
												</span>
												<!--end:Input-->
											</label>
											<!--end::Option-->
											...
											<label class="d-flex flex-stack mb-5 cursor-pointer">
												...
												<!--begin:Input-->
												<span class="form-check form-check-custom form-check-solid">
													<input class="form-check-input" type="radio" name="department" value="GAS" />
												</span>
												<!--end:Input-->
											</label>
											<!--end::Option-->
											...
											<label class="d-flex flex-stack mb-5 cursor-pointer">
												...
												<!--begin:Input-->
												<span class="form-check form-check-custom form-check-solid">
													<input class="form-check-input" type="radio" name="department" value="ICT" />
												</span>
												<!--end:Input-->
											</label>
											<!--end::Option-->
											...
											<label class="d-flex flex-stack mb-0 cursor-pointer">
												...
												<!--begin:Input-->
												<span class="form-check form-check-custom form-check-solid">
													<input class="form-check-input" type="radio" name="department" value="HE" />
												</span>
												<!--end:Input-->
											</label>
											<!--end::Option-->
							...
							<div class="" data-kt-stepper-element="content">
								...
								<div class="w-100">
									...
									<div class="pb-8 pb-lg-10">
										<!--begin::Title-->
										<h2 class="fw-bolder text-dark">Faculty Has Been Added!</h2>
										<!--end::Title-->
									</div>
									<!--end::Heading-->
									<!--begin::Body-->
									<div class="mb-0">
										<!--begin::Text-->
										<div class="fs-6 text-gray-600 mb-5">Faculty has been successfully added to our online grading system.</div>
										<!--end::Text-->
									</div>
									<!--end::Body-->
								</div>
