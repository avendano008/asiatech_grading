		...
		<div class="card card-flush">
			...
			<div class="card-header align-items-center py-5 gap-2 gap-md-5">
				...
				<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
					...
					<div class="w-150px">
						<!--begin::Select2-->
						<select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Strand" data-kt-student-list-filter="strand">
							<option></option>
				...
				<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_report_student_list_table">
					...
					<tbody class="fw-bold text-gray-600">
						...
						<tr>
							...
							<!--end::Section=-->
							<!--begin::Gender=-->
							<td class="d-none">Female</td>
							<!--end::Gender=-->
							<!--begin::Birth date=-->
							<td class="d-none">12/17/2002</td>
							<!--end::Birth date=-->
							<!--begin::Age=-->
							<td class="d-none">20</td>
							<!--end::Age=-->
							<!--begin::Address=-->
							<td class="d-none">Brgy. Caingin, City of Santa Rosa, Laguna</td>
							<!--end::Address=-->
							<!--begin::Contact email=-->
							<td class="d-none">emmasmith@gmail.com</td>
							<!--end::Contact email=-->
							<!--begin::Contact number=-->
							<td class="d-none">09123456789</td>
							<!--end::Contact number=-->
						</tr>
						<!--end::Table row-->
					</tbody>
