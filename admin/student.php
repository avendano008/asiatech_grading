...
<div class="post d-flex flex-column-fluid" id="kt_post">
	...
	<div id="kt_content_container" class="container-xxl">
		...
		<div class="card card-flush">
									...
									<div class="stepper-nav">
										...
										<div class="stepper-item" data-kt-stepper-element="nav">
											...
											<div class="stepper-label">
												...
												<div class="stepper-desc fw-bold">A Student Has Been Added</div>
											</div>
											<!--end::Label-->
										</div>
										<!--end::Step 5-->
									...
									<form class="form" novalidate="novalidate" id="kt_modal_add_student_form">
										...
										<div class="" data-kt-stepper-element="content">
											...
											<div class="w-100">
												...
												<div class="mb-0">
													<!--begin::Text-->
													<div class="fs-6 text-gray-600 mb-5">A student has been successfully added to our online grading system.</div>
													<!--end::Text-->
												</div>
												<!--end::Body-->
											</div>
			...
			<div class="modal fade" id="kt_modal_edit_student" tabindex="-1" aria-hidden="true">
				<!--begin::Modal dialog-->
				<div class="modal-dialog modal-dialog-centered mw-900px">
					<!--begin::Modal content-->
					<div class="modal-content">
						...
						<div class="modal-body py-lg-10 px-lg-10">
							<!--begin::Stepper-->
							<div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid" id="kt_modal_edit_student_stepper">
								<!--begin::Aside-->
								<div class="d-flex justify-content-center justify-content-xl-start flex-row-auto w-100 w-xl-300px">
									<!--begin::Nav-->
									<div class="stepper-nav">
										...
										<div class="stepper-item" data-kt-stepper-element="nav">
											...
											<div class="stepper-label">
												<h3 class="stepper-title">Complete</h3>
												<div class="stepper-desc fw-bold">A Student Has Been Updated</div>
											</div>
											<!--end::Label-->
										</div>
										<!--end::Step 5-->
								...
								<div class="flex-row-fluid py-lg-5 px-lg-15">
									<!--begin::Form-->
									<form class="form" novalidate="novalidate" id="kt_modal_edit_student_form">
										<!--begin::Step 1-->
										<div class="current" data-kt-stepper-element="content">
											<!--begin::Wrapper-->
											<div class="w-100">
