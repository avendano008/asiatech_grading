...
var KTCreatefaculty = function () {
	...
	return {
		...
		init: function () {
			// Elements
			modalEl = document.querySelector('#kt_modal_create_faculty');
			...
			stepper = document.querySelector('#kt_modal_create_faculty_stepper');
			form = document.querySelector('#kt_modal_create_faculty_form');
